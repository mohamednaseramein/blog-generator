 ...
 */
import { ClipboardList, PenTool, Rocket, Search, ShieldCheck, Sparkles, Users, } from 'lucide-react';
export const landingContent = {
    hero: {
        ...
        illustrationAlt: 'AI Blog Generator workspace showing a draft with an authenticity score and section-level breakdown',
    },
    features: {
        sectionTitle: 'Everything you need to publish with confidence',
        sectionSubtitle: 'From topic to publishable draft — with the signals you need to ship work that reads like a human wrote it.',
        cards: [
            {
                id: 'ai-blog-generation',
                icon: PenTool,
                title: 'AI Blog Generation',
                description: 'Generate structured drafts from a brief, audience, and outline — not from a single prompt.',
            ...
            },
            {
                ...
                description: 'Readability score, meta description, slug, and headings handled — no manual SEO checklist.',
                learnMoreHref: '#how-it-works',
            },
            {
                ...
                description: 'In-product score with rule-level evidence and surgical fixes — not a vague third-party verdict.',
            ...
            },
            {
                ...
                description: 'Voice, audience, and intent live on the profile — every draft inherits them, no re-prompting.',
                learnMoreHref: '#how-it-works',
            },
        ],
    },
        ...
        steps: [
            {
                ...
                description: 'Share the angle, who it is for, and any must-hit points. Your author profile keeps voice and intent consistent across drafts.',
            },
            {
                id: 'step-draft',
                icon: Sparkles,
                title: 'Generate a draft',
                description: 'We build an outline you can sanity-check, then generate structured sections — not a wall of generic filler.',
            },
            {
                id: 'step-review',
                icon: ShieldCheck,
                title: 'Review SEO and authenticity',
                description: 'See readability and on-page SEO signals alongside an authenticity score with concrete fixes, not a mystery verdict.',
            },
            {
                id: 'step-publish',
                icon: Rocket,
                title: 'Publish or export',
                description: 'Copy rich text or Markdown, tune the meta description and slug, and ship when it matches your bar.',
            },
        ],
    },
    socialProof: {
    ...
    pricing: {
        ...
        disclaimer: 'Pricing is illustrative for v1 — billing not yet enabled. All paid features are free during this preview.',
        tiers: [
            {
                id: 'free',
                name: 'Free',
