            ...
            : state.step === 'outline' ? 3
                : state.step === 'draft' ? 4
                    : state.step === 'publish' ? 5
                        : 1;
    return (_jsxs("div", { className: "min-h-screen bg-gradient-to-br from-slate-50 to-indigo-50", children: [_jsx(AppHeader, {}), _jsxs("div", { className: "mx-auto max-w-2xl px-4 py-10 sm:px-6 lg:px-8", children: [_jsxs("div", { className: "mb-10 text-center", children: [_jsx("h1", { className: "text-3xl font-bold tracking-tight text-slate-900", children: "AI Blog Generator" }), _jsx("p", { className: "mt-2 text-sm text-slate-500", children: "Create a fully-structured, SEO-ready blog post in minutes." }), role === 'admin' && (_jsx("div", { className: "mt-3", children: _jsx("a", { href: "/admin/users", className: "text-sm text-indigo-600 hover:underline", children: "Admin Dashboard" }) }))] }), (state.step === 'brief' || state.step === 'alignment' || state.step === 'outline' || state.step === 'draft' || state.step === 'publish') && (_jsx("div", { className: "mb-8", children: _jsx(WizardProgress, { current: wizardStep }) })), _jsxs("div", { className: "rounded-2xl bg-white shadow-sm ring-1 ring-slate-200 p-6 sm:p-8", children: [state.step === 'profile-wizard' && (_jsx(ProfileWizard, { onProfileSelected: (profile) => {
